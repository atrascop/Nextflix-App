...
function Row({ title, movies }: props) {
  ...
  return (
    <div className="h-40 space-y-0.5 md:space-y-2">
      <h1 className="w-56 cursor-pointer text-sm font-semibold text-shadow-md text-[#e5e5e5]  transition duration-200 hover:text-white md:text-2xl">
        {title}
      </h1>
